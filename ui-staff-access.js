...
(function(){
  ...
  const StaffAccessAdmin={
    async save(eventId,staffId){
      ...
      s.staffAccessSavedAt=new Date().toISOString(); Events.update(eventId,{staffAssignments:e.staffAssignments}); alert('Staff event access saved. They can use the Staff Portal with this email.');
    },
